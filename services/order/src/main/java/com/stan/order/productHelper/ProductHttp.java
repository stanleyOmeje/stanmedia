...
public class ProductHttp {
    ...
    public DefaultResponse<GrandPurchaseResponse> purchaseProduct(List<PurchaseRequest> request) {
        ...
        ParameterizedTypeReference<DefaultResponse<GrandPurchaseResponse>> responseType =
            new ParameterizedTypeReference<>() {
            };
        ResponseEntity<DefaultResponse<GrandPurchaseResponse>> response =
